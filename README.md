...
|----------|---------|------------------------------------|--------------------------------------------------------|-----------------------------------------------------|-----------------------------------------------------|
| **User0** | Windows | 21, 22                             | Apache, Smss, Svchost, Tomcat                           | 1. Svchost - 1 <br> 2. Smss - 2 <br> 3. Apache - 3 <br> 4. Tomcat - 4 | FTPDirTraversal (port 21) : 7 <br> SSHBruteForce (port 22) : 0.1 |
| **User1** | Windows | 21, 22                             | Apache, Smss, Svchost, Tomcat                           | 1. Svchost - 1 <br> 2. Smss - 2 <br> 3. Apache - 3 <br> 4. Tomcat - 4 | FTPDirTraversal (port 21) : 7 <br> SSHBruteForce (port 22) : 0.1 |
| **User2** | Windows | 445, 139, 135, 3389                | Apache, SSHd, Tomcat, Fermitter                         | 1. SSHd - 0.1 <br> 2. Apache - 3 <br> 3. Tomcat - 4 <br> 4. Fermitter - 7 | EternalBlue (port 139) : 2 <br> BlueKeep (port 3389) : 1 |
| **User3** | Linux   | 25, 80, 443, 3390                  | SSHd, Vsftpd                                            | 1. SSHd - 0.1 <br> 2. Vsftpd - 7                     | HarakaRCE (port 25) : 6 <br> SQLInjection (port 3390 and 80/443) : 5 <br> HTTPsRFI (port 443) : 4 <br> HTTPRFI (port 80) : 3 <br> BlueKeep (port 3389) : 1 |
...
| **Ent0** | Linux   | 22                                 | Apache, Tomcat, Vsftpd, HarakaSMPT                      | 1. Apache - 3 <br> 2. Tomcat - 4 <br> 3. Vsftpd - 7 <br> 4. HarakaSMPT - 6 | SSHBruteForce (port 22) : 0.1 |
...
| **Op_host0** | Linux| 22                                 | Apache, HarakaSMPT, Tomcat, Vsftpd                      | 1. Vsftpd - 7 <br> 2. HarakaSMPT - 6 <br> 3. Tomcat - 4 <br> 4. Apache - 3 | SSHBruteForce (port 22) : 0.1 |
| **Op_host1** | Linux| 22                                 | Apache, HarakaSMPT, Tomcat, Vsftpd                      | 1. Vsftpd - 7 <br> 2. HarakaSMPT - 6 <br> 3. Tomcat - 4 <br> 4. Apache - 3 | SSHBruteForce (port 22) : 0.1 |
| **Op_host2** | Linux| 22                                 | Apache, HarakaSMPT, Tomcat, Vsftpd                      | 1. Vsftpd - 7 <br> 2. HarakaSMPT - 6 <br> 3. Tomcat - 4 <br> 4. Apache - 3 | SSHBruteForce (port 22) : 0.1 |
| **Op_Server0** | Linux| 22                               | Apache, HarakaSMPT, Tomcat, Vsftpd                      | 1. Vsftpd - 7 <br> 2. HarakaSMPT - 6 <br> 3. Tomcat - 4 <br> 4. Apache - 3 | SSHBruteForce (port 22) : 0.1 |
