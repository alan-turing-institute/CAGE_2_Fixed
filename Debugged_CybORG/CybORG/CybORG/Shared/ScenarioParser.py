...
if __name__ == "__main__":
    ...
    parser.add_argument("--file_path", type=str, default='./Scenarios/Scenario2.yaml',
                        help="/Users/ebates/PycharmProjects/Cage2_canonical/cage-challenge-2/CybORG/CybORG/Shared/Scenarios/Scenario2q.yaml")
